...
function chkdir($dir,$p="") {
    if ( isset($_SESSION['erppath']) && file_exists($_SESSION['erppath']."crm/dokumente/".$_SESSION["dbname"]."/".$dir) ) { 
        ...
        $tmp  = $_SESSION["dbname"]."/";
        foreach ( $dirs as $dir ) {
            if ( !file_exists($_SESSION['erppath']."crm/dokumente/$tmp".$dir) ) {
                if ( isset($_SESSION['dir_mode']) && $_SESSION['dir_mode'] != ''  ) {
                    $ok = @mkdir($_SESSION['erppath']."crm/dokumente/$tmp".$dir, $_SESSION['dir_mode']);
                } else {
                    $ok = @mkdir($_SESSION['erppath']."crm/dokumente/$tmp".$dir);
                }
                if ( isset($_SESSION['dir_group']) && $_SESSION['dir_group'] && $ok ) @chgrp($_SESSION['erppath']."crm/dokumente/$tmp".$dir,$_SESSION['dir_group']); 
                if ( !$ok ) {
                    return false;
                }
            };
