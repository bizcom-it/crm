...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true) {
        //$this->xxx=fopen('/tmp/fileup.log','a');
        $this->options = array(
            'rename'     => true,
        ...
        //fputs($this->xxx,print_r($options,true));
        //fputs($this->xxx,print_r($this->options,true));
        if ($initialize) {
            $this->initialize();
        }
    }
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            $file->size = $file_size;
            chmod ($file_path,$this->options['mkdir_mode']);
            //if ( $this->options['file_group'] != '' )   chgrp ($file_path,$this->options['file_group']);
            $this->set_file_delete_properties($file);
        }
        return $file;
    }
