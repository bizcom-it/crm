...
<!-- Beginn Code ------------------------------------------->
<h1 class="toplist" style="margin-top: 20px; padding: 0.6em;">| 
...
<a href="#" onClick="setLetter('~');" class="fett">*</a> |</h1>
	<div class="zeile">
	...
	<div class="zeile">
		  ...
		  <div class="zeile">
			...
			<div class="zeile">
                <span class="klein">.:search:. <input type="radio" name="andor" value="and" checked tabindex="40">.:all:. <input type="radio" name="andor" value="or" tabindex="40">.:some:.</span><br>
