...
{JQTABLE}
	...
	<script language="JavaScript">
		function material() {
			f=open("artikel.php?aid={AID}&mid={mid}","artikel","width=625,height=550,left=10,top=10");
		}
		function drucke(nr)  {
	...
	<script>
    $(function() {
        $( "#datum" ).datepicker($.datepicker.regional[ "de" ]).val('');
  		$("#treffer")
...
{PRE_CONTENT}
{START_CONTENT}
<h1 class="toplist  ui-widget  ui-corner-all tools content1" onClick="help('Reparatur');">Reparaturauftrag eingeben/editieren</h1><br>
...
<input type="hidden" name="anlagedatum" value="{anlagedatum}">
<input type="hidden" name="bearbdate" value="{bearbdate}">
<table style="width:80%">
	...
	<tr>
		...
		<td class="norm"><span style='color:red; font-weight:bold;'>{msg}</span><br>
	...
	<tr>
		...
		<td class="norm" width="*"><input type="text" size="9" name="datum" id="datum" tabindex='3' value="{datum}"><br>Repariert am<br>
                                   <input type="text" size="9" name="dauer" id="dauer" tabindex='3' value="{dauer}"><br>Dauer
        </td>		
	</tr>	
	<tr>
		...
		<td class="norm" rowspan="2" nowrap>
            ...
            <select id='bearbeiter' name="bearbeiter" tabindex="1">
<!-- BEGIN Userbox -->
