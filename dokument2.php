<?php
    ...
    $did = ( isSetVar($_GET['did']) )?$_GET['did']:(( isSetVar($_POST['did']) )?$_POST['did']:false);
    $doc = False;
    $msg = '';
    $docdata['document'] = array('vorlage'=>false,'beschreibung'=>false,'file'=>false);
