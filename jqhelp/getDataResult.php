    ...
    echo '
        <span id="pager" class="pager">
            <form>
                ...
                <img src="'.$_SESSION['baseurl'].'crm/jquery/plugin/tablesorter-master/addons/pager/icons/last.png" class="last"/> '.($anzahl < $_SESSION['listLimit'] ? $anzahl : $_SESSION['listLimit']).'
